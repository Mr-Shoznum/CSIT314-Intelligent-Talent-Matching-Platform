...
Currently, the experience and education sections are not producing great result>
JSON output. However, name, contact info, and skills are working well, and cert>
are partially working.

The following steps will provide the information nessary to get the 
[resume-scanner.py](https://github.com/Mr-Horrigan/CSIT314-Intelligent-Talent-Matching-Platform/tree/main/back-end/scripting/python-scritps)
